...
main() {
  ...
  //const lista = ['Ana', 'Paulo', 'Vitu', 'Bari']; -> não deixa ser alterada pois é uma constante de tempo de compilação e não deixa os elementos da lista serem alterados, diferente do final que é uma constante de tempo de execução deixa os elementos da lista serem alterados; //vai dar erro pois os elementos da lista estão marcados como constante
